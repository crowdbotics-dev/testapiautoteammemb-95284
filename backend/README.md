...
## Project Structure
    ...
    ├── testapiautoteammemb_95284  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_95284`
...
2. Clone this repo and `cd testapiautoteammemb_95284`
